...
def pause(screen):
    ...
    marco_1_image_nivel = pygame.image.load("images/gui/gui/20.png")
    ...
    marco_2_image_nivel = pygame.image.load("images/gui/gui/21.png")
...
def win (screen):
    marco_1_image_win = pygame.image.load("images/gui/gui/20.png")
    ...
    marco_2_image_win = pygame.image.load("images/gui/gui/21.png")
...
def dead_screen(screen):
    ...
    marco_5_image_win = pygame.image.load("images/gui/gui/20.png")
    marco_5_image_win = pygame.transform.scale(marco_5_image_win, (100, 50))
    marco_5_rect_win = pygame.Rect(ANCHO_VENTANA / 2 -250, ALTO_VENTANA / 2+110, 90, 90)  # Ajusta las coordenadas y el tamaño según sea necesario

    marco_6_image_win = pygame.image.load("images/gui/gui/21.png")
    marco_6_image_win = pygame.transform.scale(marco_6_image_win, (100, 50))
    marco_6_rect_win = pygame.Rect(ANCHO_VENTANA / 2-30, ALTO_VENTANA / 2+110, 90, 90)  # Ajusta las coordenadas y el tamaño según sea necesario

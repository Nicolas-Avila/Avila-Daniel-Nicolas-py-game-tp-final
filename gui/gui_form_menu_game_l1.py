...
class FormGameLevel1(Form):
    def __init__(self,name,master_surface,x,y,w,h,color_background,color_border,active):
        ...
        # --- GAME ELEMNTS --- 
        self.static_background = Background(x=0,y=0,width=w,height=h,path="images/locations/set_bg_01/castle.png")

        self.player_1 = Player(x=100,y=500,speed_walk=10,speed_run=10,gravity=10,jump_power=40,frame_rate_ms=150,move_rate_ms=60,jump_height=140,p_scale=1.2,interval_time_jump=100,enemy = enemy)
    ...
    def update(self, lista_eventos,keys,delta_ms):
        ...
        self.player_1.bullet.update()

        for index, enemy in enumerate(self.enemy_list):
            enemy.update(delta_ms, self.plataform_list, self.enemy_list, index)
    ...
    def draw(self): 
        ...
        self.player_1.bullet.draw(self.surface)
    ...
    while True:
        for index, enemy in enumerate(self.enemy_list):
            enemy.update(delta_ms, plataform_list, self.enemy_list, index)
            enemy.draw(self.plataform_list)
